...
public class test {
    ...
    public void imgGreytoPixelTab(){
        ...
        public void changeGreyAssombrissement(){
            byte grey;
            for (int i=0; i<this.tabGrey.length; i++){
                grey = (byte)(this.tabGrey[i]*this.tabGrey[i]/255);
                this.tabGrey[i]= grey;   
                }
            }
        ...
        public void changeGreyEclairage(){
            ...
            for (int i=0; i<this.tabGrey.length; i++){
                if (this.tabGrey[i]>0){
                grey = (byte)(Math.sqrt(this.tabGrey[i])*Math.sqrt(255));
                }
                else {
                    grey = (byte)(Math.sqrt(this.tabGrey[i])/Math.sqrt(255));
                }
    ...
    public static void main(String[] args) {
        ...
        String fn = "F:/Cours/MaM3/ProjetIPA/images/shining-gs.png";
        test t = new test();
        byte b=-17;
        ...
        if (t.isRGB){
            ...
            t.imgGreytoPixelTab();
            for (int i=0; i<t.tabGrey.length; i++){
                
            }
            t.changeGreyAssombrissement();
            t.changeGreyEclairage();
